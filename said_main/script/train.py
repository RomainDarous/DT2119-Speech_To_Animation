...
from dataset_voca import DataBatch, BlendVOCATrainDataset, BlendVOCAValDataset
...
def main() -> None:
    ...
    parser.add_argument(
        "--coeffs_dir",
        type=str,
        default="./data/blendshape_coeffs/",
    ...
    parser.add_argument(
        "--epochs", type=int, default=100_000, help="The number of epochs"
    )
    parser.add_argument(
        "--num_warmup_epochs",
        type=int,
    ...
    parser.add_argument(
        "--save_period", type=int, default=5_000, help="Period of saving model"
    )
    ...
    for epoch in range(1, epochs + 1):
        ...
        if epoch % save_period == 0 and accelerator.is_main_process:
            ...
            accelerator.save(
                ...
                os.path.join(output_dir, f"model{epoch}.pth"),
            )
    ...
    accelerator.save(
                accelerator.unwrap_model(said_model).state_dict(),
                os.path.join(output_dir, f"model.pth"),
            )
