...
class BlendVOCADataset(ABC, Dataset):
    ...
    person_ids_train = [
        "FaceTalk_Romain_Darous_train",
    ]

    person_ids_val = [
        "FaceTalk_Romain_Darous_val",
    ]

    person_ids_test = [
        "FaceTalk_Romain_Darous_test",
    ]

    sentence_ids = list(range(1, 41))

    fps = 30 # Modifier fps rate
    ...
    default_blendshape_classes = [
                                ...
                                "CheekSquintLeft","CheekSquintRight","NoseSneerLeft","NoseSneerRight","TongueOut","HeadYaw","HeadPitch",
    ...
    def get_data_paths(
        ...
        for pid in person_ids:
            ...
            for sid in self.sentence_ids:
                filename_base = f"sequence{sid:04}"
...
class BlendVOCAPseudoGTOptDataset:
    ...
    def get_mesh_seq(self, person_id: str, seq_id: int) -> List[trimesh.base.Trimesh]:
        ...
        mesh_seq_dir = os.path.join(
            self.mesh_seqs_dir_dir_dir, person_id, f"sequence{seq_id:04}"
        )
